...
export class SolicitudesGerenciaComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 40; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 40 // Cambia esto según tu lógica para obtener el ID del departamento
    };
