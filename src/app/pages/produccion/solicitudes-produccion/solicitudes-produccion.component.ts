...
export class SolicitudesProduccionComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 41; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 41 // Cambia esto según tu lógica para obtener el ID del departamento
    };
