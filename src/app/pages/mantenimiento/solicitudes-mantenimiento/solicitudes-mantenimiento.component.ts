...
@Component({
  ...
  templateUrl: './solicitudes-mantenimiento.component.html',
  styleUrl: './solicitudes-mantenimiento.component.css'
})
export class SolicitudesMantenimientoComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 36; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 36 // Cambia esto según tu lógica para obtener el ID del departamento
    };
