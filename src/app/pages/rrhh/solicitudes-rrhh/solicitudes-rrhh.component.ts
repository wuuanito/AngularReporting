...
export class SolicitudesRrhhComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 37; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 37 // Cambia esto según tu lógica para obtener el ID del departamento
    };
