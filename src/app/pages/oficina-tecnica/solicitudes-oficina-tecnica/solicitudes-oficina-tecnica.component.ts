...
export class SolicitudesOficinaTecnicaComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 42; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 42 // Cambia esto según tu lógica para obtener el ID del departamento
    };
