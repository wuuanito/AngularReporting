...
@Component({
  selector: 'app-solicitudes-administracion',
  standalone: true,
  ...
  templateUrl: './solicitudes-administracion.component.html',
  styleUrl: './solicitudes-administracion.component.css'
})
export class SolicitudesAdministracionComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 39; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 39 // Cambia esto según tu lógica para obtener el ID del departamento
    };
