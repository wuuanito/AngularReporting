...
export class SolicitudesLaboratorioComponent {
  ...
  getSolicitudes() {
    const idDepartamento = 43; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 43 // Cambia esto según tu lógica para obtener el ID del departamento
    };
