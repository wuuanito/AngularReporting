...
export class SolicitudesLogisticaComponent {
  solicitud?: string;
  ...
  getSolicitudes() {
    const idDepartamento = 44; // Cambia esto según tu lógica para obtener el ID del departamento
  ...
  submitForm(form: NgForm) {
    const formData = {
      ...
      id_departamento: 44 // Cambia esto según tu lógica para obtener el ID del departamento
    };
